...
int main()
{
  ...
  double omegaB,alpha,beta,tf,tcl;
  double G[M*M/4],B[M*M/4],lambda[2][2],sigma[2][2];
  double Gf[M*M/4],Bf[M*M/4];
  ...
  Gf[0*M/2+0] =  7.631257631257632;
  Gf[0*M/2+1] = -3.815628815628816;
  Gf[0*M/2+2] = -3.815628815628816;
  Gf[1*M/2+0] = -3.815628815628816;
  Gf[1*M/2+1] =  6.839334669523348;
  Gf[1*M/2+2] = -3.023705853894533;
  Gf[2*M/2+0] = -3.815628815628816;
  Gf[2*M/2+1] = -3.023705853894533;
  Gf[2*M/2+2] =  1006.839334669523348;

  Bf[0*M/2+0] = -38.053788156288157;
  Bf[0*M/2+1] =  19.078144078144078;
  Bf[0*M/2+2] =  19.078144078144078;
  Bf[1*M/2+0] =  19.078144078144078;
  Bf[1*M/2+1] = -34.081673347616743;
  Bf[1*M/2+2] =  15.118529269472663;
  Bf[2*M/2+0] =  19.078144078144078;
  Bf[2*M/2+1] =  15.118529269472663;
  Bf[2*M/2+2] = -34.081673347616743;
  ...
  if (!in) printf("Warning: File \"physics.inp\" not found. Using default values.\n");
    ...
    if (!strcmp(word, "begin")){
        ...
        if      (!strcmp(word,"PM1"    ))  {ferr=fscanf(in,"%lf",&PM1   ) ;if(ferr!=1)return(1);}
        ...
        else if (!strcmp(word,"tf"     ))  {ferr=fscanf(in,"%lf",&tf    ) ;if(ferr!=1)return(1);}
        else if (!strcmp(word,"tcl"    ))  {ferr=fscanf(in,"%lf",&tcl   ) ;if(ferr!=1)return(1);}
          ...
          ferr=fscanf(in,"%lf",&Gf[0*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[0*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[0*M/2+2]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[1*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[1*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[1*M/2+2]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[2*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[2*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Gf[2*M/2+2]) ;if(ferr!=1)return(1);
        } else if (!strcmp(word,"Bf"))  {
          ferr=fscanf(in,"%lf",&Bf[0*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[0*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[0*M/2+2]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[1*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[1*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[1*M/2+2]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[2*M/2+0]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[2*M/2+1]) ;if(ferr!=1)return(1);
          ferr=fscanf(in,"%lf",&Bf[2*M/2+2]) ;if(ferr!=1)return(1);
  ...
  fprintf(out,"\n");
  fprintf(out,"\tGf\n");
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Gf[0*M/2+0],Gf[0*M/2+1],Gf[0*M/2+2]);
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Gf[1*M/2+0],Gf[1*M/2+1],Gf[1*M/2+2]);
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Gf[2*M/2+0],Gf[2*M/2+1],Gf[2*M/2+2]);
  fprintf(out,"\n");
  fprintf(out,"\tBf\n");
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Bf[0*M/2+0],Bf[0*M/2+1],Bf[0*M/2+2]);
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Bf[1*M/2+0],Bf[1*M/2+1],Bf[1*M/2+2]);
  fprintf(out,"\t                   %1.16E %1.16E %1.16E\n",Bf[2*M/2+0],Bf[2*M/2+1],Bf[2*M/2+2]);
  fprintf(out,"\n");
