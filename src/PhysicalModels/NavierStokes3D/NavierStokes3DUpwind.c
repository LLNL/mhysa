  ...
  while (!done) {
    ...
    for (index_inter[dir] = 0; index_inter[dir] < bounds_inter[dir]; index_inter[dir]++) {
      ...
      for (k = 0; k < _MODEL_NVARS_; k++) {
        ...
        _NavierStokes3DEigenvalues_((uL+_MODEL_NVARS_*p),D,param,dir); eigL = D[k*_MODEL_NVARS_+k];
        _NavierStokes3DEigenvalues_((uR+_MODEL_NVARS_*p),D,param,dir); eigR = D[k*_MODEL_NVARS_+k];
        _NavierStokes3DEigenvalues_(uavg,D,param,dir);         eigC = D[k*_MODEL_NVARS_+k];
