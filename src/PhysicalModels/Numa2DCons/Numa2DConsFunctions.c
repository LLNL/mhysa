...
int Numa2DConsCalculateStandardAtmosphere_1(void *p,double z,double *ExnerP,double *P,double *rho,double *T)
{
  Numa2DCons *physics = (Numa2DCons*) p;
...
int Numa2DConsCalculateStandardAtmosphere_2(void *p,double z,double *ExnerP,double *P,double *rho,double *T)
{
  Numa2DCons *physics = (Numa2DCons*) p;
