...
int Interp1PrimFifthOrderHCWENOChar(double *fI,double *fC,double *u,int upw,int dir,void *s,void *m)
{
  ...
  if (mpi->ip[dir] != mpi->iproc[dir]-1) for (d=0; d<Nsys*nvars; d++) F[d+Nsys*dim[dir]] = recvbuf[d];
